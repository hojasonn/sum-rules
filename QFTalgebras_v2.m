...
(*Levi::usage = "Levi Civita symbol in 3D or 4D"*)
...
Begin["`Private`"]
(*Kronecker Delta in color and Dirac space*)
...
g/:g[\[Mu]_,\[Nu]_] momentum[p_,\[Nu]_|\[Mu]_] :=momentum[p,\[Mu]] 
...
momentumConvert:={p.p->p^2, q.q->q^2,k.k->k^2}
momentumUnConvert:={p^2->p.p, q^2->q.q,k^2->k.k}
